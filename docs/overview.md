...
This folder holds operational docs for maintaining the public platform and
syncing it into private client repositories.

Use the docs in this repo by scope:
...
Private or client-specific notes should not live here. Keep those in:

- the private client repo `docs/` folder
