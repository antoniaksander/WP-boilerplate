 ...
 *
 * Categories: sobe-general (default) | sobe-woocommerce | sobe-sliders | sobe-content
 *
 * Creates:
...
const VALID_CATEGORIES = ['sobe-general', 'sobe-woocommerce', 'sobe-sliders', 'sobe-content'];
